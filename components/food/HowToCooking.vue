  ...
  <div class='mt-7'>
    ...
    <div class='mt-8'>
      <div class='step-overlay scrollbar-track-gray-200 scrollbar-thumb-indigo-500 scrollbar-thin'>
        <div ref='steps' class='pl-24 relative'>
          <div class='-translate-y-1/2 absolute bg-indigo-500 left-12 step-overlay-line t-1/2 top-1/2 transform w-0.5' :style='{ height: height + "px" }'></div>
          <div v-for='(step, index) in recipe.stepper' :key='index' class='my-5 relative mb-10 pr-5'>
          <span class='-left-12 -translate-x-1/2 -translate-y-1/2 absolute step-icon text-white top-1/2 transform shadow-lg'>
