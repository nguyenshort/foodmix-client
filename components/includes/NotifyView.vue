<template>
  <transition-group id="app-noti" tag="div" name="notify">
    <div
      ...
      :key="notify.id"
      class='-translate-x-1/2 -translate-y-1/2 visible opacity-100 capitalize duration-300 fixed left-1/2 px-10 py-3 rounded-lg shadow-2xl text-lg text-white top-1/2 transform transition z-50'
      :class='{
