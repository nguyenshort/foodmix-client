<template>
  <footer>
    ...
    <div class=" bg-gray-900">
      <div class="max-w-6xl mx-auto text-white py-10">
        <div class="text-center">
          <h3 class="xl:text-3xl text-2xl mb-3"> Tải Ngay Ứng Dụng Của Bạn  </h3>
        ...
        <div class="flex flex-col md:flex-row md:justify-between items-center text-sm text-gray-400">
          <p class="order-2 md:order-1 mt-8 md:mt-0"> &copy; FoodMix, 2021. </p>
