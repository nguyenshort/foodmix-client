<template>
  <footer>
    ...
    <div class="">
      <div class="max-w-6xl m-auto text-gray-700 flex flex-wrap justify-center">
        <div class="p-5 w-48 ">
          ...
          <a class="my-3 block" href="/#">Products <span class="text-teal-600 text-xs p-1"></span></a>
    ...
    <div class="pt-2 ">
      <div class="flex pb-5 px-3 m-auto pt-5 border-t text-gray-700 text-sm flex-col
